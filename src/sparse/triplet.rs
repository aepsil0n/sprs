...
impl<'a, N, I, IS, DS> Into<TriMatIter<Iter<'a, I>, Iter<'a, I>, Iter<'a, N>>>
for &'a TriMatBase<IS, DS>
where I: SpIndex,
      IS: Deref<Target=[I]>,
      DS: Deref<Target=[N]>,
{
    fn into(self) -> TriMatIter<Iter<'a, I>, Iter<'a, I>, Iter<'a, N>> {
        self.triplet_iter()
    }
}

impl<'a, N, I> Into<TriMatIter<Iter<'a, I>, Iter<'a, I>, Iter<'a, N>>>
for TriMatViewI<'a, N, I>
where I: SpIndex,
{
    fn into(self) -> TriMatIter<Iter<'a, I>, Iter<'a, I>, Iter<'a, N>> {
